...
console.log("\nCheck if the string \"substring\" contains the substring \"string\": " + stringUtils.contains("substring","string"))
console.log("Check if the string \"substring\" contains the substring \"number\": " + stringUtils.contains("substring","number"))
